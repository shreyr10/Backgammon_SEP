...
//				}
	...
	//	infoPanel.addText("How much points do you wish to play");
		...
		String play_point = JOptionPane.showInputDialog(null,"How much points do you wish to play?");
		JOptionPane.showMessageDialog(null, "Points: " + play_point);
		int point = Integer.parseInt(play_point);
		
		
		

		for(int w=1;w<=point;w++)
		{
...
//				frame.add(infoPanel, BorderLayout.EAST);
		...
		do
		{
			...
			{
				infoPanel.addText("Enter double to throw a doubling cube");
...
//					TurnMove tuy = new TurnMove(INDEX,r1,r2,control_double,cube_number);
//					frame.add(tuy);
//					frame.repaint();
//
//					frame.revalidate();
						...
						if(arr[0][x] > 0)
						{
							...
							if(x-(roll_1*m)>=hy)
							{
								...
								if(arr[1][x-(roll_1*m)] == 0)
								{
									...
									{
										st[s] = Integer.toString(x) + " " + Integer.toString(x-(roll_1*m));
										s++;
									}
								}
						...
						if(arr[1][x] > 0)
						{
							...
							if(x+(roll_1*n)<=hen)
							{
								...
								else
								{
									...
									{
										st[s] = Integer.toString(25-x) + " " + Integer.toString(25 - (x+(roll_1*n)));
										s++;
									}
					...
					if(arr[0][x] > 0)
					{
						...
						if(x - roll_1 - roll_2 >=hy)
						{
							...
							if(arr[1][x - roll_1 - roll_2] == 0)
							{
								...
								{
									st[s] = Integer.toString(x) + " " + Integer.toString(x - roll_1 - roll_2);
									s++;
								}
							}
					...
					if(arr[1][x] > 0)
					{
						if(x+roll_1<=hen)
						{
							...
							{	
								if(arr[0][x+roll_1] == 0)
								{
									st[s] = Integer.toString(25-x) + " " + Integer.toString(25 - (x+roll_1));
									s++;
								}
						...
						if(x+roll_2<=hen)
						{
							...
							else
							{
								if(arr[0][x+roll_2] == 0)
								{
									st[s] = Integer.toString(25-x) + " " + Integer.toString(25 - (x+roll_2));
									s++;
								}
						...
						if(x+roll_2+roll_1<=hen)
						{
							...
							else
							{
								...
								{
									st[s] = Integer.toString(25-x) + " " + Integer.toString(25 - (x+roll_2+roll_1));
									s++;
								}
						...
						if(arr[1][x] > 0)
						{
							...
							if(x+next_move <=hen)
							{
								...
								else
								{
									...
									{
										st[s] = Integer.toString(25-x) + " " + Integer.toString(25 - (x+next_move));
										s++;
									}
